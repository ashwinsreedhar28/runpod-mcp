...
Hosted and local serve the same **68 tools** (51 generated from the v2 OpenAPI
spec + 17 curated). Both transports also serve the ten Runpod task playbooks as MCP resources under
